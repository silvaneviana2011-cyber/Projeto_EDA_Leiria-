# -*- coding: utf-8 -*-
"""
Pie Chart do DataFrame consolidado de incendios florestais.
...
def criar_dataframe_consolidado():
    """Cria o dataframe mensal consolidado usado no Pie Chart."""
...
print("===== DataFrame usado no Pie Chart =====")
print(df)


# =========================
# 5. PIE CHART - AREA ARDIDA
# =========================

df_area = df[df["area_ardida_mensal"] > 0].copy()

if df_area.empty:
    print("\nNao existem valores de area ardida para criar o Pie Chart.")
else:
    plt.figure(figsize=(8, 8))

    plt.pie(
        df_area["area_ardida_mensal"],
        labels=df_area["nome_mes"],
        autopct="%1.1f%%",
        startangle=90,
        counterclock=False,
    ...
    plt.title(
        "Distribuicao da area ardida por mes - 2025",
        fontsize=14,
        fontweight="bold"
    )
...
# =========================
# 6. PIE CHART - NUMERO DE INCENDIOS
# =========================

df_incendios = df[df["numero_incendios_mensal"] > 0].copy()

if df_incendios.empty:
    print("\nNao existem valores de incendios para criar o Pie Chart.")
else:
    plt.figure(figsize=(8, 8))

    plt.pie(
        df_incendios["numero_incendios_mensal"],
        labels=df_incendios["nome_mes"],
        autopct="%1.1f%%",
        startangle=90,
        counterclock=False,
        wedgeprops={"edgecolor": "white", "linewidth": 1}
    ...
    plt.title(
        "Distribuicao do numero de incendios por mes - 2025",
        fontsize=14,
        fontweight="bold"
    )
