# -*- coding: utf-8 -*-
"""
PlotBar do DataFrame consolidado de incendios florestais.
...
ficheiro_temperatura = pasta / "temp_max_2025-leiria.csv"
ficheiro_pdsi = pasta / "mpdsi-per_seca1009-leiria.csv"
ficheiro_area_ardida = pasta / "ardida_2025.dbf"
ficheiro_saida_area = pasta / "plotbar_area_ardida_2025.png"
ficheiro_saida_incendios = pasta / "plotbar_numero_incendios_2025.png"
...
def criar_dataframe_consolidado():
    """Cria o dataframe mensal consolidado usado no grafico."""
    validar_ficheiros()
...
def validar_ficheiros():
    """Confirma se os ficheiros necessarios existem antes da analise."""
    ficheiros_necessarios = [
        ficheiro_temperatura,
        ficheiro_pdsi,
        ficheiro_area_ardida
    ]

    ficheiros_em_falta = [
        str(caminho) for caminho in ficheiros_necessarios
        if not caminho.exists()
    ]

    if ficheiros_em_falta:
        mensagem = "Ficheiros em falta:\n" + "\n".join(ficheiros_em_falta)
...
print("===== DataFrame usado no PlotBar =====")
print(df)


# =========================
# 5. PLOTBAR - AREA ARDIDA MENSAL
# =========================
...
plt.xlabel("Mes")
plt.ylabel("Area ardida mensal (ha)")
...
plt.tight_layout()
plt.savefig(ficheiro_saida_area, dpi=300, bbox_inches="tight")
plt.show()


# =========================
# 6. PLOTBAR - NUMERO DE INCENDIOS
# =========================
...
plt.tight_layout()
plt.savefig(ficheiro_saida_incendios, dpi=300, bbox_inches="tight")
plt.show()
